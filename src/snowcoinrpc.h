...
#ifndef _snowcoinRPC_H_
#define _snowcoinRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // snowcoin is not connected
...
/**
 * snowcoin RPC command dispatcher.
 */
class CRPCTable
{
private:
